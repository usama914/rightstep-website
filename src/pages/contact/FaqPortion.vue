<template>
  <div class="faq-card">
    <div class="heading mb-5">
      <h2 class="title-five text-center">Frequently asked questions</h2>
      <p class="text-default">
        We provide a complete service for the sale, purchase or rental of real estate. We
        provide a complete <br> service for the sale.
      </p>
    </div>
    <div class="questions">
